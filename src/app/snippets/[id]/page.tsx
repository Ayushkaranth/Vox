...
function SnippetDetailPage() {
  ...
  const snippet = useQuery(api.functions.snippets.getSnippetById, { snippetId: snippetId as Id<"snippets"> });
  const comments = useQuery(api.functions.snippets.getComments, { snippetId: snippetId as Id<"snippets"> });
